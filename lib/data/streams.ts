...
export const STREAMS: Stream[] = [
    {
        ...
        scope: "Global setups in Chennai (SaaS) & Coimbatore (Manufacturing).",
    ...
    },
    {
        ...
        scope: "Huge shortage in rural TN. Tier-2 cities (Madurai/Trichy) are new hubs.",
    ...
    },
    {
        ...
        scope: "TN's strict corporate culture values groomed managers.",
    ...
    },
    {
        ...
        scope: "Auditing, Finance, Tax. Every TN business needs one.",
    ...
    },
    {
        ...
        scope: "Corporate firms in Chennai pay ₹10L+. Litigation is social service initially.",
    ...
    },
    {
        ...
        scope: "Data Science (B.Sc Stats), English Lit (Content), Psych (HR).",
    ...
    },
    {
        ...
        scope: "Chennai is a cinema/media hub. Digital marketing is booming.",
    ...
    },
    {
        ...
        scope: "Agri-tech startups, Banking (AFO), Civil Services.",
    ...
    },
    {
        ...
        scope: "Tourism in TN (Mahabs, Ooty). Cruise lines.",
    ...
    },
    {
        ...
        scope: "High demand in Chennai hospitals (Apollo/MGM) & Abroad.",
    ...
    },
    {
        ...
        scope: "Mental health crisis needs specialists. HR & UX Research.",
    ...
    },
    {
        ...
        scope: "TN has highest Gross Enrolment Ratio. Teachers always needed.",
